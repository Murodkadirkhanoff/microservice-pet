...
const (
	AuthService_Login_FullMethodName       = "/grpc.auht.AuthService/Login"
	AuthService_Register_FullMethodName    = "/grpc.auht.AuthService/Register"
	AuthService_Profile_FullMethodName     = "/grpc.auht.AuthService/Profile"
	AuthService_VerifyToken_FullMethodName = "/grpc.auht.AuthService/VerifyToken"
	AuthService_SaveProfile_FullMethodName = "/grpc.auht.AuthService/SaveProfile"
)
...
func (c *authServiceClient) SaveProfile(ctx context.Context, in *SaveProfileRequest, opts ...grpc.CallOption) (*SaveProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveProfileResponse)
	err := c.cc.Invoke(ctx, AuthService_SaveProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) SaveProfile(context.Context, *SaveProfileRequest) (*SaveProfileResponse, error) {
...
func _AuthService_SaveProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).SaveProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_SaveProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SaveProfile(ctx, req.(*SaveProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.auht.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_SaveProfile_Handler,
		},
	},
